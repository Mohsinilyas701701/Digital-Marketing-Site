    ...
    <div className='company_info'>
      <Container>
        <Row className='justify-content-center'>
          <Col md={10}>
            <div className='company_info_content p-5'>
              ...
              <p>
                At Element 8 web design dubai, we are passionate people who think in delivering
                outstanding results. At Element 8 web design Dubai you can count on us to be an
              ...
              <p>
                ...
                about our work, Element 8 web design Dubai keeps everything 100% in-house. From
